...
.bio-name{font-family:'Playfair Display',serif;font-size:1.4rem;font-weight:800;color:#0A4A58;
    text-align:center;margin:.8rem 0 .1rem;}
.bio-title{font-family:'Cormorant Garamond',serif;font-style:italic;color:#1A7A8C;
    font-size:1rem;text-align:center;}
.bio-loc{font-size:.85rem;color:#B8956B;text-align:center;margin:.1rem 0;}

.bio-card{background:#FFFFFF;border:2px solid #88C5D0;border-radius:16px;padding:2rem;
...
.quote-block{background:linear-gradient(135deg,#FFFFFF,#E8F4F6);border-left:5px solid #1A7A8C;
...
.swamiji-quote{background:linear-gradient(135deg,#FFFFFF,#E8F4F6);border-left:5px solid #1A7A8C;
    ...
    color:#1A3A45;line-height:1.8;box-shadow:0 2px 8px rgba(0,0,0,.07);}
...
.tag{display:inline-block;background:#FFFFFF;border:1.5px solid #88C5D0;color:#0A4A58;
...
.value-bullet{color:#1A7A8C;font-size:1rem;margin-right:.6rem;flex-shrink:0;}
...
.section-title{font-family:'Playfair Display',serif;font-size:1.6rem;font-weight:700;
    color:#0A4A58;margin:2rem 0 1rem;padding-bottom:.4rem;border-bottom:2px solid #88C5D0;}
...
with col_photo:
    ...
    <div style="font-family:'Cormorant Garamond',serif;font-style:italic;
        color:#3A5C68;font-size:.92rem;text-align:center;margin:.2rem 0;">
    ...
    <div style="font-size:.82rem;text-align:center;margin:.3rem 0;">
        <a href="mailto:swamiaparajitananda@gmail.com" style="color:#1A7A8C;
...
<div class="bio-card">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:.8rem;margin-top:.8rem;">
        <div style="background:#FFFFFF;border:1.5px solid #88C5D0;border-radius:10px;padding:.8rem 1rem;">
            <div style="font-family:'Playfair Display',serif;font-weight:700;color:#0A4A58;font-size:.95rem;">📖 Gurudev's Quotes — Volume I</div>
            <div style="font-size:.82rem;color:#3A5C68;margin-top:.2rem;"><strong>2007</strong> · Selected quotes from Pūjya Swāmī Chinmayānandajī</div>
        </div>
        <div style="background:#FFFFFF;border:1.5px solid #88C5D0;border-radius:10px;padding:.8rem 1rem;">
            <div style="font-family:'Playfair Display',serif;font-weight:700;color:#0A4A58;font-size:.95rem;">📖 Gurudev's Quotes — Volume II</div>
            <div style="font-size:.82rem;color:#3A5C68;margin-top:.2rem;"><strong>2010</strong> · Selected quotes from Pūjya Swāmī Chinmayānandajī</div>
        </div>
        <div style="background:#FFFFFF;border:1.5px solid #88C5D0;border-radius:10px;padding:.8rem 1rem;">
            ...
            <div style="font-size:.82rem;color:#3A5C68;margin-top:.2rem;"><strong>2013</strong> · Selected quotes from Pūjya Swāmī Chinmayānandajī</div>
        </div>
        <div style="background:#FFFFFF;border:1.5px solid #88C5D0;border-radius:10px;padding:.8rem 1rem;">
            <div style="font-family:'Playfair Display',serif;font-weight:700;color:#0A4A58;font-size:.95rem;">📖 Read Daily, Live Fully</div>
            <div style="font-size:.82rem;color:#3A5C68;margin-top:.2rem;"><strong>2017</strong> · A daily spiritual companion for seekers</div>
        </div>
        <div style="background:#FFFFFF;border:1.5px solid #88C5D0;border-radius:10px;padding:.8rem 1rem;grid-column:1/-1;border-left:5px solid #0A4A58;">
            <div style="font-family:'Playfair Display',serif;font-weight:700;color:#0A4A58;font-size:1rem;">📖 Indispensable Values</div>
            <div style="font-size:.82rem;color:#3A5C68;margin-top:.2rem;"><strong>2022</strong> · Central Chinmaya Mission Trust · 37 values from Bhagavad Gītā Chapters 13 &amp; 16</div>
        </div>
    </div>
</div>
''', unsafe_allow_html=True)
...
<div style="text-align:center;margin-top:2rem;padding:1.5rem;
    ...
    background:linear-gradient(135deg,#FFFFFF,#E8F4F6);border-radius:12px;">
    🪷 &nbsp; Hari Om &nbsp; 🪷 <br>
