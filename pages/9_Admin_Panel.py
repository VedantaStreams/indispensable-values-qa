...
.section-card{background:white;border:2px solid #B8D4BC;border-radius:14px;padding:1.8rem;margin-bottom:1.5rem;box-shadow:0 2px 10px rgba(74,124,89,.06);}
.section-title{font-family:'Playfair Display',serif;font-size:1.4rem;font-weight:700;color:#2A5C3A;margin-bottom:1rem;padding-bottom:.4rem;border-bottom:2px solid #B8D4BC;}
...
.upload-hint{background:#EDF3EC;border-radius:10px;padding:1rem 1.2rem;font-size:.9rem;
    color:#3A5040;margin-bottom:1rem;border-left:4px solid #4A7C59;line-height:1.7;}
.workflow-step{display:flex;align-items:flex-start;gap:.8rem;margin-bottom:.6rem;font-size:.9rem;color:#3A5040;}
...
.file-row{display:flex;align-items:center;gap:.8rem;background:#EDF3EC;
    border:1px solid #B8D4BC;border-radius:8px;padding:.6rem 1rem;
